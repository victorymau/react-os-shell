...
import { PanelActions, ToolbarSlotContext } from './_panelActions';
import {
...
export default function Preview() {
  ...
  if (!data) {
    ...
    body = <PdfViewer key={data.url} url={data.url} filename={data.filename} onDownload={data.onDownload} onEmail={data.onEmail} />;
  }
